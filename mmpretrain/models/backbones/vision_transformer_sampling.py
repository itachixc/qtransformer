...
class FFNSampling(BaseModule):
    ...
    def forward(self, x, identity=None):
        ...
        if identity is None:
            identity = x
        return identity + self.sampling(self.dropout_layer(out))
...
@MODELS.register_module()
class VisionTransformerSampling(BaseBackbone):
    """Vision Transformer.
    ...
    def __init__(self,
        ...
        super(VisionTransformerSampling, self).__init__(init_cfg)
    ...
    def init_weights(self):
        super(VisionTransformerSampling, self).init_weights()
