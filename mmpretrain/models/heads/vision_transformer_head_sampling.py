...
from ..utils import SamplingBlock

@MODELS.register_module()
class VisionTransformerClsHeadSampling(ClsHead):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(VisionTransformerClsHeadSampling, self).__init__(
    ...
    def init_weights(self):
        ...
        super(VisionTransformerClsHeadSampling, self).init_weights()
